    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('donor', 'Donor'), ('hospital', 'Hospital'), ('admin', 'Admin')], default='donor', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='inventory', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SOSAlert',
